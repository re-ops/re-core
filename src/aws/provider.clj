...
(defn wait-for-ssh [{:keys [endpoint instance-id user] :as instance} timeout]
    (wait-for {:timeout timeout}
...
(defn update-pubdns [{:keys [spec endpoint instance-id] :as instance}]
...
(defn set-hostname [{:keys [spec endpoint instance-id user] :as instance}]
