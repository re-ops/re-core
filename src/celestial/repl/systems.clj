(ns celestial.repl.systems
  ...
  (:require
    ...
    [celestial.repl.base :refer [Repl select-keys* with-admin]])
  (:import [celestial.repl.base Systems]))
...
(defn refer-systems []
  (require '[celestial.repl.systems :as sys :refer [stop watch create status]]))
