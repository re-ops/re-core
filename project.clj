(defproject celestial "0.2.6"
  ...
  :dependencies [[org.clojure/clojure "1.5.1"]
                 ...
                 [narkisr/clj-aws-ec2 "0.2.3" :exclusions  [org.codehaus.jackson/jackson-core-asl]]
  ...
  :topping {
      :service "celestial"
      :app {:app-name "celestial" :src "target/celestial-0.2.6.jar"}
